...
I/O words are 16-bit signed Q8.8; MAC/division intermediates are kept as
32-bit Q16.16 (the natural width of a 16x16 signed product) and only
rescaled/saturated back to Q8.8 when written to an I/O register.
"""
